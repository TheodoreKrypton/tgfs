...
class TestOps:
    ...
    def test_ls_file(self, ops, mock_root_directory, mocker):
        ...
        ops._client.dir_api.get_fr.assert_called_once_with(mock_root_directory, "file.txt")
    ...
    async def test_mv_dir(self, ops, mocker):
        ...
        mocker.patch.object(ops, 'cp_dir', return_value=(mock_source_dir, mock_dest_dir))
    ...
    async def test_mv_file(self, ops, mocker):
        ...
        mocker.patch.object(ops, 'cp_file', return_value=(mock_source_file, mock_dest_file))
    ...
    async def test_download_success(self, ops, mocker):
        ...
        ops._client.file_api.retrieve = mocker.AsyncMock(return_value=mock_data_stream())
