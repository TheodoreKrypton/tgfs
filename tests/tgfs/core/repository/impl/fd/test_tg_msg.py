...
class TestSaveMethod:
    ...
    @pytest.mark.asyncio
    async def test_save_new_file_descriptor(
        self, repository, mock_message_api, sample_file_desc
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_update_existing_file_descriptor(
        self, repository, mock_message_api, sample_file_desc, sample_file_ref
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_message_not_found_fallback(
        self, repository, mock_message_api, sample_file_desc, sample_file_ref
    ):
        ...
        mock_message_api.edit_message_text.side_effect = MessageNotFound(0)
    ...
    @pytest.mark.asyncio
    async def test_save_preserves_other_exceptions(
        self, repository, mock_message_api, sample_file_desc, sample_file_ref
    ):
...
class TestGetMethod:
    ...
    @pytest.mark.asyncio
    async def test_get_valid_message(
        self, repository, mock_message_api, sample_file_ref
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_missing_message(
        self, repository, mock_message_api, sample_file_ref
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_with_include_all_versions(
        self, repository, mock_message_api, sample_file_ref
    ):
        ...
        mock_message.text = json.dumps(
            {
                ...
                "versions": [
                    ...
                    },
                    {
                        "id": "v2",
                        "updatedAt": int(
                            datetime.datetime(2023, 2, 1).timestamp() * 1000
                        ),
                        "messageIds": [22222],
                        "size": 2000,
                    },
...
class TestValidateFvMethod:
    ...
    async def test_validate_fv_missing_document(self, repository, mock_message_api):
        ...
        version1 = TGFSFileVersion(
            id="v1", updated_at=datetime.datetime.now(), _size=1000, message_ids=[444]
        )
        fd.versions = {"v1": version1}
        fd.latest_version_id = "v1"
    ...
    @pytest.mark.asyncio
    async def test_validate_fv_partial_invalid_versions(
        self, repository, mock_message_api
    ):
        ...
        # Valid version
        version1 = TGFSFileVersion(
            id="v1", updated_at=datetime.datetime.now(), _size=1000, message_ids=[555]
        )
        # Invalid version (missing message)
        version2 = TGFSFileVersion(
            id="v2", updated_at=datetime.datetime.now(), _size=2000, message_ids=[666]
        )
    ...
    @pytest.mark.asyncio
    async def test_validate_fv_early_return_on_valid_version(
        self, repository, mock_message_api
    ):
        ...
        version1 = TGFSFileVersion(
            id="v1", updated_at=datetime.datetime.now(), _size=1000, message_ids=[777]
        )
        version2 = TGFSFileVersion(
            id="v2", updated_at=datetime.datetime.now(), _size=2000, message_ids=[888]
        )
    ...
    @pytest.mark.asyncio
    async def test_validate_fv_multi_part_file_with_missing_part(
        self, repository, mock_message_api
    ):
...
class TestIntegrationScenarios:
    ...
    @pytest.mark.asyncio
    async def test_update_workflow_with_fallback(
        self, repository, mock_message_api, sample_file_desc, sample_file_ref
    ):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_get_with_malformed_json(
        self, repository, mock_message_api, sample_file_ref
    ):
    ...
    async def test_validate_with_api_error(self, repository, mock_message_api):
        ...
        version1 = TGFSFileVersion(
            id="v1", updated_at=datetime.datetime.now(), _size=1000, message_ids=[999]
        )
        fd.versions = {"v1": version1}
...
class TestEdgeCases:
    ...
    async def test_validate_fv_with_zero_size_file(self, repository, mock_message_api):
        ...
        version1 = TGFSFileVersion(
            id="v1", updated_at=datetime.datetime.now(), _size=0, message_ids=[1111]
        )
        fd.versions = {"v1": version1}
    ...
    @pytest.mark.asyncio
    async def test_get_with_complex_file_structure(
        self, repository, mock_message_api, sample_file_ref
    ):
    ...
    @pytest.mark.asyncio
    async def test_validate_fv_with_large_message_id_list(
        self, repository, mock_message_api
    ):
