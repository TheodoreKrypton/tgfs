...
class TestFSCache:
    ...
    def test_split_path_multi_level(self):
        ...
        assert FSCache.split_path("/test/sub/file.txt") == ["", "test", "sub", "file.txt"]
        assert FSCache.split_path("test/sub/file.txt") == ["", "test", "sub", "file.txt"]
        assert FSCache.split_path("/test/sub/file.txt/") == ["", "test", "sub", "file.txt"]
    ...
    def test_split_path_special_characters(self):
        ...
        assert FSCache.split_path("/test/file with spaces") == ["", "test", "file with spaces"]
        assert FSCache.split_path("/test/file@domain.com") == ["", "test", "file@domain.com"]
...
class TestIntegrationScenarios:
    ...
    def test_complex_file_system_simulation(self):
        ...
        cache.set("/src/utils/helper.py", MockMember("/src/utils/helper.py", "helper.py"))
        
        # Test retrieval
        assert cache.get("/").name == "root"
        assert cache.get("/docs/readme.txt").name == "readme.txt"
        assert cache.get("/src/utils/helper.py").name == "helper.py"
    ...
    def test_concurrent_path_access(self):
        ...
        assert cache.get("/test").name == "test_dir"
        assert cache.get("/test/file1").name == "file1"
        assert cache.get("/test/file2").name == "file2"
        assert cache.get("/test/subdir").name == "subdir"
        assert cache.get("/test/subdir/file3").name == "file3"
